        ...
        <div>
            ...
            <div className="lg:max-w-7xl mx-auto">
                <div className="card card-side bg-[#DDD0C8] shadow-xl w-2/3 mx-auto mb-10">
                    <figure><img className="md:h-72 md:w-96" src="https://i.ibb.co/cLrJfZQ/customer5.jpg" alt="" /></figure>
                ...
                <div className="card card-side bg-[#DDD0C8] shadow-xl w-2/3 mx-auto mb-10">
                    <figure><img className="md:h-72 md:w-96" src="https://i.ibb.co/NyLYzGT/customer2.jpg" alt="" /></figure>
                    <div className="card-body">
                ...
                <div className="card card-side bg-[#DDD0C8] shadow-xl w-2/3 mx-auto mb-10">
                    <figure><img className="md:h-72 md:w-96" src="https://i.ibb.co/XVBy78P/customer3.jpg" alt="" /></figure>
                    <div className="card-body">
                ...
                <div className="card card-side bg-[#DDD0C8] shadow-xl w-2/3 mx-auto mb-10">
                    <figure><img className="md:h-72 md:w-96" src="https://i.ibb.co/NFN32R4/customer4.jpg" alt="" /></figure>
                    <div className="card-body">
                ...
                <div className="card card-side bg-[#DDD0C8] shadow-xl w-2/3 mx-auto mb-10">
                    <figure><img className="md:h-72 md:w-96" src="https://i.ibb.co/DLPyy3g/customer1.jpg" alt="" /></figure>
                    <div className="card-body">
