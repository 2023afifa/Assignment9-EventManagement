    ...
    return (
        <div>
            ...
            <div className="grid lg:grid-cols-3 gap-24" data-aos="zoom-in-down">
                ...
                <div>
                    <img className="h-[500px] w-[350px]" src="https://i.ibb.co/r5ttQMW/woman3.jpg" alt="" />
                    <p className="mt-3 text-center text-neutral-400">"Greetings! I'm Olivia, and I believe in the power of exceptional customer service. Your satisfaction is our top priority. We're here to listen to your ideas, understand your vision, and make sure your event is a reflection of you. Let's make your event planning journey enjoyable and memorable."</p>
